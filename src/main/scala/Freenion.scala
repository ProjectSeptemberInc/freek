...
// trait FreenionHelpers extends FreenionHelpersLow {

//   implicit class toOnionT[F[_], G[_], A](free: Free[F, G[A]]) {

//     def onion[S <: Onion](implicit lifter: Lifter[G, S]): Freenion[F, S, A] =
...
// trait FreenionHelpersLow {

//   implicit class toOnionF[F[_], G[_], A](free: Free[F, A]) {
