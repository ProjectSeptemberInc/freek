...
//       // CopIso[
//       //   In3[Log.DSL, HttpInteract, HttpHandle, ?],
//       //   AppendK[In1[Log.DSL, ?], AppendK[In1[HttpInteract, ?], AppendK[In1[HttpHandle, ?], CNilK, ?], ?], ?]
//       // ]

//       // CopIso[
//       //   In2[Log.DSL, DB.DSL, ?],
//       //   AppendK[In1[Log.DSL, ?], AppendK[In1[DB.DSL, ?], CNilK, ?], ?]
//       // ]
